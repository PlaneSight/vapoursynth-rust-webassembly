...
VapourSynth is licensed under the GNU Lesser General Public License, version 2.1 or later. Its complete source, upstream copyright notices, and this project's browser-specific patch are available through the pinned submodule and patches/vapoursynth/0001-static-browser-spike.patch.
